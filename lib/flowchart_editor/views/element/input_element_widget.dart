...
class InputElementWidget extends StatelessWidget {
  ...
  const InputElementWidget({super.key, required this.positionIndex});
    ...
    return GestureDetector(
      ...
      child: Selector2<FlowchartViewModel, FlowchartEditorViewModel, Tuple2<String, bool>>(
          ...
          builder: (_, data, __) => CustomPaint(
            painter: _InputElementPainter(color: data.item2 ? Colors.green : Colors.blue),
...
class _InputElementPainter extends CustomPainter {
  final Color color;

  _InputElementPainter({required this.color});
  ...
  @override
  bool shouldRepaint(covariant _InputElementPainter oldDelegate) {
