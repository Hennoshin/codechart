...
class OutputElementWidget extends StatelessWidget {
  ...
  const OutputElementWidget({super.key, required this.positionIndex});
    ...
    return GestureDetector(
      ...
      child: Selector2<FlowchartViewModel, FlowchartEditorViewModel, Tuple2<String, bool>>(
          ...
          builder: (_, data, __) => CustomPaint(
            painter: _OutputElementPainter(color: data.item2 ? Colors.green : Colors.blue),
...
class _OutputElementPainter extends CustomPainter {
  final Color color;

  _OutputElementPainter({required this.color});
  ...
  @override
  bool shouldRepaint(covariant _OutputElementPainter oldDelegate) {
